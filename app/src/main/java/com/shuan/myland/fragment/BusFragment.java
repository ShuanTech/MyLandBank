...
public class BusFragment extends Fragment {
    ...
    public HashMap<String,String> busData;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.bus);
    ...
    public class GetBus extends AsyncTask<String,String,String> {

        @Override
        protected String doInBackground(String... params) {
            busData=new HashMap<String,String>();
            busData.put("loc",mApp.getSharedPreferences().getString(Common.PRO_LOC,""));

            try{
                JSONObject json=parser.makeHttpUrlConnection(php.pro_facility_bus,busData);
                ...
                if(succ==0){
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txt.setText("Couldn't find a Bus Stand");
                        }
                    });
                }else {
                    JSONArray jsonArray=json.getJSONArray("bus");
