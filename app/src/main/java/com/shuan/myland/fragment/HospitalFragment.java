...
public class HospitalFragment extends Fragment {
    ...
    public HashMap<String,String> hosData;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.hos);
    ...
    public class GetHospital extends AsyncTask<String,String,String> {

        @Override
        protected String doInBackground(String... params) {
            hosData=new HashMap<String,String>();
            hosData.put("loc",mApp.getSharedPreferences().getString(Common.PRO_LOC,""));

            try{
                JSONObject json=parser.makeHttpUrlConnection(php.pro_facility_hospital,hosData);
                ...
                if(succ==0){
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txt.setText("Couldn't find a Hospital");
                        }
                    });
                }else {
