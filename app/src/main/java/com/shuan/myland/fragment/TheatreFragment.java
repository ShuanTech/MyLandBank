...
public class TheatreFragment extends Fragment {
    ...
    public HashMap<String, String> theatreData;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.theatre);
        ...
        new GetTheatre().execute();
        progressBar.setVisibility(View.VISIBLE);


    }

    public class GetTheatre extends AsyncTask<String,String,String> {

        @Override
        protected String doInBackground(String... params) {
            theatreData=new HashMap<String,String>();
            theatreData.put("loc",mApp.getSharedPreferences().getString(Common.PRO_LOC,""));

            try{
                JSONObject json=parser.makeHttpUrlConnection(php.pro_facility_theatre,theatreData);
                ...
                if(succ==0){
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txt.setText("Couldn't find a Theatre");
                        }
                    });
                }else {
                    JSONArray jsonArray=json.getJSONArray("theatre");
