...
package com.shuan.myland.rangebar;
...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.marker;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.marker;
