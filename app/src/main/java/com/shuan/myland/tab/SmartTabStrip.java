...
public class SmartTabStrip extends LinearLayout{
    ...
    private SmartTab.TabColorizer customTabColorizer;
    ...
    public SmartTabStrip(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SmartTabStrip(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SmartTab);
        indicatorAlwaysInCenter = a.getBoolean(
                R.styleable.SmartTab_indicatorAlwaysCenter, indicatorAlwaysInCenter);
        indicatorWithoutPadding = a.getBoolean(
                R.styleable.SmartTab_indicatorWithoutPadding, indicatorWithoutPadding);
        indicatorInFront = a.getBoolean(
                R.styleable.SmartTab_indicatorInFront, indicatorInFront);
        indicationInterpolatorId = a.getInt(
                R.styleable.SmartTab_indicatorInterpolation, indicationInterpolatorId);
        indicatorGravity = a.getInt(
                R.styleable.SmartTab_indicatorGravity, indicatorGravity);
        indicatorColor = a.getColor(
                R.styleable.SmartTab_indicatorColor, indicatorColor);
        indicatorColorsId = a.getResourceId(
                R.styleable.SmartTab_indicatorColors, indicatorColorsId);
        indicatorThickness = a.getDimensionPixelSize(
                R.styleable.SmartTab_indicatorThickness, indicatorThickness);
        indicatorCornerRadius = a.getDimension(
                R.styleable.SmartTab_indicatorCornerRadius, indicatorCornerRadius);
        overlineColor = a.getColor(
                R.styleable.SmartTab_overlineColor, overlineColor);
        overlineThickness = a.getDimensionPixelSize(
                R.styleable.SmartTab_overlineThickness, overlineThickness);
        underlineColor = a.getColor(
                R.styleable.SmartTab_underlineColor, underlineColor);
        underlineThickness = a.getDimensionPixelSize(
                R.styleable.SmartTab_underlineThickness, underlineThickness);
        dividerColor = a.getColor(
                R.styleable.SmartTab_dividerColor, dividerColor);
        dividerColorsId = a.getResourceId(
                R.styleable.SmartTab_dividerColors, dividerColorsId);
        dividerThickness = a.getDimensionPixelSize(
                R.styleable.SmartTab_dividerThickness, dividerThickness);
        a.recycle();
    ...
    void setCustomTabColorizer(SmartTab.TabColorizer customTabColorizer) {
    ...
    SmartTab.TabColorizer getTabColorizer() {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final SmartTab.TabColorizer tabColorizer = getTabColorizer();
    ...
    private static class SimpleTabColorizer implements SmartTab.TabColorizer {
